sap.ui.define(["sap/ui/core/mvc/Controller",
	"sap/m/MessageBox",
	"./AddProjectDialog", "./CreatePersoneelDialog",
	"./utilities",
	"sap/ui/core/routing/History"
], function(BaseController, MessageBox, AddProjectDialog, CreatePersoneelDialog, Utilities, History) {
	"use strict";

	return BaseController.extend("com.sap.build.standard.prototypePlaceholderName.controller.MasterPage1", {
		...
		_onButtonPress: function() {
			...
			var sDialogName = "CreatePersoneelDialog";
			this.mDialogs = this.mDialogs || {};
			var oDialog = this.mDialogs[sDialogName];

			if (!oDialog) {
				oDialog = new CreatePersoneelDialog(this.getView());
		...
		_onObjectListItemPress: function(oEvent) {
			...
			return new Promise(function(fnResolve) {
				...
				this.doNavigate("DetailPageUser", oBindingContext, fnResolve, "");
		...
		_onButtonPress1: function() {
			...
			var sDialogName = "AddProjectDialog";
			this.mDialogs = this.mDialogs || {};
			var oDialog = this.mDialogs[sDialogName];

			if (!oDialog) {
				oDialog = new AddProjectDialog(this.getView());
				this.mDialogs[sDialogName] = oDialog;
		...
		_onObjectListItemPress4: function(oEvent) {
			...
			return new Promise(function(fnResolve) {
				this.doNavigate("DetailPageProjects", oBindingContext, fnResolve, "");
			}.bind(this)).catch(function(err) {
				if (err !== undefined) {
					MessageBox.error(err.message);
				}
